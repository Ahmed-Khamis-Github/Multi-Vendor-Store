    ...
    <div class="cart-items">
        ...
        <div class="shopping-item">
            ...
            <ul class="shopping-list">
                ...
                <li>
                    ...
                    <div class="content">
                        ...
                        <p class="quantity">{{ $item->quantity }}x - <span class="amount">{{ Currency::format($item->product->price * $item->quantity) }}</span></p>
                    </div>
                </li>
                @endforeach
            ...
            <div class="bottom">
                ...
                <div class="button">
                    <a href="{{ asset('checkout.html" class="btn animate') }}">Checkout</a>
                </div>
            </div>
        </div>
        <!--/ End Shopping Item -->
